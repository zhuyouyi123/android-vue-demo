...
import com.db.database.dao.NotificationAppListDAO;
...
@Database(entities = {UserInfoDO.class, DeviceDO.class, UserTargetConfigurationDO.class, ConfigurationDO.class, NotificationAppListDO.class}, version = 1, exportSchema = false)
public abstract class UserDatabase extends RoomDatabase {
    ...
    public abstract NotificationAppListDAO getNotificationAppListDAO();
